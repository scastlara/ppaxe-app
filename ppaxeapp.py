    ...
    if 'identifiers' in request.form:
        ...
        try:
            ...
            for article in query.articles:
                ...
                sentences = Parallel(n_jobs=int(NJOBS), backend="threading", verbose=int(os.environ.get('PPAXE_DEBUG', 0)))(map(delayed(parallel_predict_interactions), article.sentences))
